<template>
    <div class="MuiBox-root css-1qcmu60">
        <div class="MuiBox-root css-ruafan" >
            <div class="MuiBox-root css-bvn10m">
                <div class="MuiBox-root css-12aqe7t " data-aos="fade-down">
                    <p class="MuiTypography-root MuiTypography-body1 css-zsryf0">Subscribe to Our Newsletter</p>
                    ...
                    <hr class="MuiDivider-root MuiDivider-fullWidth MuiDivider-vertical css-an0l0s"><a href="Mailto:baozhongmail@yeah.net?Subject=contract me &Body=你好"
                        ...
                        </svg><span class="MuiTouchRipple-root css-w0pj6f"></span></a>
                </div>
    ...
    <p class="MuiTypography-root MuiTypography-body1 css-1jmggb0">© 2023 BTNU – All rights reserved</p>
</div>
</template>
<script setup>
</script>
